          ...
          <div className="h-full px-3 py-4 overflow-y-auto bg-violet-700 ">
            <ul className="space-y-2 font-medium">
              <li>
                <a
                  href="#"
                  className="flex items-center p-2 text-white rounded-lg  hover:bg-gray-100 hover:text-violet-700 group"
                >
                  <svg
              ...
              <li>
                ...
                >
                  ...
                  <span className="flex-1 ms-3 whitespace-nowrap">Manage Project</span>
                </a>
              </li>
              <li>
                <a
