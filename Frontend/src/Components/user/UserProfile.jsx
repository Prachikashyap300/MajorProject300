...
const UserProfile = () => {
  return (
    <>
    {/* component */}
    <div className="p-relative h-screen mt-28" style={{ backgroundColor: "#15202b" }}>
      <div className="flex justify-center">
        <header className="text-white h-12 py-4 h-auto">
          {/* Navbar (left side) */}
          <div style={{ width: 275 }}>
            <div
              className="overflow-y-auto fixed h-screen pr-3"
              style={{ width: 275 }}
            >
              {/*Logo*/}
              <svg
                      ...
                      >
                        <div
                          ...
                          style={{
                            height: 100,
                            backgroundImage:
                              "url(https://instagram.flis9-1.fna.fbcdn.net/v/t51.2885-15/sh0.08/e35/s640x640/116865832_615803592697921_5045643941059143720_n.jpg?_nc_ht=instagram.flis9-1.fna.fbcdn.net&_nc_cat=101&_nc_ohc=EQFsJZNRIPMAX-pb8EZ&tp=1&oh=1ffba368dc5827c172420060b811d1c4&oe=60433210)"
                          }}
                        >
                          <img
                            className="opacity-0"
                      ...
                      >
                        <div
                          ...
                          style={{
                            height: 100,
                            backgroundImage:
                              "url(https://instagram.flis9-1.fna.fbcdn.net/v/t51.2885-15/e35/33476414_2111389325772141_4942435591556956160_n.jpg?_nc_ht=instagram.flis9-1.fna.fbcdn.net&_nc_cat=109&_nc_ohc=m4fof_6edMQAX8y6Mma&tp=1&oh=66d43f3c9ef1e6d35aa27b5ea79fc566&oe=6045E945)"
                          }}
                        >
                          <img
                            className="opacity-0"
                      ...
                      >
                        <div
                          ...
                          style={{
                            height: 100,
                            backgroundImage:
                              "url(https://instagram.flis9-1.fna.fbcdn.net/v/t51.2885-15/e35/28765942_569404996768567_810640940719931392_n.jpg?_nc_ht=instagram.flis9-1.fna.fbcdn.net&_nc_cat=107&_nc_ohc=Xf0LrzDMbp8AX8S55zD&tp=1&oh=0cf858806b52e56cc9093211b2656831&oe=6045F090)"
                          }}
                        >
                          <img
                            className="opacity-0"
                      ...
                      >
                        <div
                          ...
                          style={{
                            height: 100,
                            backgroundImage:
                              "url(https://instagram.flis9-1.fna.fbcdn.net/v/t51.2885-15/e35/27877940_216827205533781_6550488685962330112_n.jpg?_nc_ht=instagram.flis9-1.fna.fbcdn.net&_nc_cat=109&_nc_ohc=ihm93wr5mUUAX_w6e1G&tp=1&oh=e492418bf694b130464f681f9fedd180&oe=60442B6C)"
                          }}
                        >
                          <img
                            className="opacity-0"
                      ...
                      >
                        <div
                          ...
                          style={{
                            height: 100,
                            backgroundImage:
                              "url(https://instagram.flis9-1.fna.fbcdn.net/v/t51.2885-15/e35/22277804_1824335967579893_4558955485163683840_n.jpg?_nc_ht=instagram.flis9-1.fna.fbcdn.net&_nc_cat=105&_nc_ohc=CknMgBUYNhcAX-Jxi0P&tp=1&oh=631583468373481077e1834df4031435&oe=6045BD08)"
                          }}
                        >
                          <img
                            className="opacity-0"
